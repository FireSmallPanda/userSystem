		...
		<div class="am-modal-bd">
			<form class="am-form am-form-horizontal " id="forgetFrom" data-am-validator >
				...
				<div class="am-g am-form-group">
					...
					<div class="am-u-sm-4">
						<button type="button" class="am-btn am-btn-sm am-btn-secondary" id="sentEmailCode" >发送验证码</button>
					</div>
				</div>
				<div class="am-g am-form-group">
...
<@override name="javascript">
	...
	var submitForgetFrom = function(){
		...
		fornVals.userAccount = $("#forgetUserAccount").val();
		$.ajax({
			type: "post",
